...
// Persisted acceleration evidence may fail closed after a wall-clock rollback: future timestamps never survive.
...
// The persistent origin index is pure, deterministic and hard-bounded.
...
console.log('profile-core: PASS (6500 differential/property cases + fail-closed schema invariants)');
