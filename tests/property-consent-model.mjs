...
// Keep focused cross-category edge cases here. Language coverage itself belongs to
// fixtures/language-corpus.mjs + language-parity.mjs so one language cannot silently
// gain routine authority without matching risk evidence.
const routineEdges = [
