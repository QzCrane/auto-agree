...
assert.equal(JSON.stringify(calls[1].files),JSON.stringify(['runtime-kernel.js','generation-lease.js','semantic-core.js','handover-guard.js','risk-core.js','engine.js']));
