...
assert.equal(JSON.stringify(calls[1].files),JSON.stringify(['runtime-kernel.js','generation-lease.js','semantic-core.js','dom-core.js','handover-guard.js','decision-core.js','profile-core.js','risk-core.js','engine.js']));
